...
! CHECK WHERE VARIABLES SHOULD BE OVERWRITTEN
        ...
        ELSEIF(LINE.EQ.LINEELAIM) THEN ! CHECK WHERE ELAIM SHOULD BE OVERWRITTEN  
          ...
          DO 903 WHILE (L.LE.ISUBNO)
            ...
            READ(11,*)D1,D2, &
              ...
              (ICC(I),I=1,12),(ALBEDO(I),I=1,12)
            READ(20,111) DUM
	        WRITE(12,221)(ELAIM(I),I=1,12),(L)
	        WRITE(30,221)(ELAIM(I),I=1,12),(L)
            WRITE(*,*) debugRES, ' CALIBRATED LINE ',LINE, '--- HRU # ',L, ' OUT OF ',ISUBNO
            WRITE(12,*) debugRES, ' CALIBRATED LINE ',LINE, '--- HRU # ',L, ' OUT OF ',ISUBNO
            L=L+1
	        LINE=LINE+1
  903     END DO
          WRITE(12,*) '=================================================================================' 
          CLOSE(11)
        ELSEIF(LINE.EQ.LINEROOTA) THEN ! CHECK WHERE ELAIM SHOULD BE OVERWRITTEN  
          OPEN(UNIT=11,FILE=VARFILE)
          READ(11,*) DUM2  ! Header
	      READ(11,*) DUM2  ! Header
          WRITE(12,*) '=================================================================================' 
          ...
          DO 904 WHILE (L.LE.ISUBNO)
            ...
            READ(11,*)D1,D2, &
              ...
              (ICC(I),I=1,12),(ALBEDO(I),I=1,12)
            READ(20,111) DUM
	        WRITE(12,221)(ROOTA(I),I=1,12),(L)
	        WRITE(30,221)(ROOTA(I),I=1,12),(L)
            WRITE(*,*) debugRES, ' CALIBRATED LINE ',LINE, '--- HRU # ',L, ' OUT OF ',ISUBNO
            WRITE(12,*) debugRES, ' CALIBRATED LINE ',LINE, '--- HRU # ',L, ' OUT OF ',ISUBNO
            L=L+1
	        LINE=LINE+1
